...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 18, 2023 lúc 08:10 AM
...
--
ALTER TABLE `answer`
  MODIFY `id_answer` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `history_message`
  MODIFY `id_history` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
