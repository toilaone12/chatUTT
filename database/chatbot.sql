...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 18, 2023 lúc 06:41 PM
...
--
ALTER TABLE `history_message`
  MODIFY `id_history` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `question`
  MODIFY `id_question` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
