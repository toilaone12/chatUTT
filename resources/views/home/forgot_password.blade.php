        ...
        <div class="row d-flex justify-content-center mt-5">
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card py-3 px-2">
                    <p class="text-center mb-3 mt-2">Đổi mật khẩu</p>
                    <?php
                    ...
                    ?>
                    <form method="POST" action="{{route('page.changePassword')}}" class="myform">
                        @csrf
                        ...
                        <div class="form-group mt-3">
                            <button type="submit" class="btn btn-block btn-primary btn-lg register"><small><i class="far fa-user pr-2"></i>Đổi mật khẩu</small></button>
